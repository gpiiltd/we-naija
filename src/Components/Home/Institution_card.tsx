  ...
  return (
    <div className="div " onClick={onClick}>
      ...
      <div className="flex justify-center w-full">
        <button className="border-[1.5px] border-[#5E5959] rounded-lg mt-6 text-[#5E5959] text-sm font-bold items-center px-[5rem] py-[1rem] lg:px-[7rem] sm:px-[5rem] md:px-[5rem]">
          Show more
        </button>
      </div>
    </div>
