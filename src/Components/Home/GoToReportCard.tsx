  ...
  return (
    ...
    >
      <section className="flex justify-between items-center">
        <p>
          Start giving reports to increase
          <br />
          your <span className="font-bold text-[#ED7D31]">Star Points.</span>
        </p>
        <Icon type="home-report-star" className="pr-2" />
      </section>
      <button className="bg-[#007A61] py-3 w-full rounded-lg mt-5 text-white text-sm font-normal">
        Go to report
      </button>
    </div>
  );
